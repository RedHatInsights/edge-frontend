...
export const releaseMapper = {
  'rhel-9.6': 'Red Hat Enterprise Linux (RHEL) 9.6',
  'rhel-95': 'Red Hat Enterprise Linux (RHEL) 9.5',
...
export const temporaryReleases = ['rhel-9.6'];

export const DEFAULT_RELEASE = 'rhel-9.6';
export const TEMPORARY_RELEASE = 'rhel-9.6';
