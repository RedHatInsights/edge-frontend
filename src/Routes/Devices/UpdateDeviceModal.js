...
const UpdateDeviceModal = ({ updateModal, setUpdateModal }) => {
  const imageData =
    updateModal.deviceData?.system_profile?.image_data?.ImageInfo?.UpdatesAvailable[
      updateModal.deviceData?.system_profile?.image_data?.ImageInfo?.UpdatesAvailable.length - 1
    ];
