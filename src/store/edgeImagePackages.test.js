import reducer from './edgeImagePackages';
...
describe('reducer', () => {
  it('should calculate pending', () => {
    expect(
      reducer(undefined, {
        type: `${LOAD_EDGE_IMAGE_PACKAGES}_PENDING`,
      })
  ...
  it('should calculate fulfilled on success', () => {
    ...
    expect(
      reducer(undefined, {
        type: `${LOAD_EDGE_IMAGE_PACKAGES}_FULFILLED`,
        payload,
      })
    ).toMatchObject({
      isLoading: false,
  ...
  it('should calculate fulfilled on error', () => {
    ...
    expect(
      reducer(undefined, {
        type: `${LOAD_EDGE_IMAGE_PACKAGES}_REJECTED`,
        payload: err,
      })
    ).toMatchObject({
      isLoading: false,
